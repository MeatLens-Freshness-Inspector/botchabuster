...
const developerDashboardOperations: ApiDocsOperation[] = [
  ...
  operation("developer-dashboard-dispute-history", "developer-dashboard", "GET", "/developer-dashboard/disputes/history", "List all inspection result dispute history", "Admin"),
