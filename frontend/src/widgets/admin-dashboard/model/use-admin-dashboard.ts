  ...
  const handleExportCSV = async () => {
    ...
    await reportExport.run("csv", (report) => {
      ...
      const rows = reportRows.map((row) => {
        ...
        return [
          exportedRow.id,
          formatReportDateTime(exportedRow.createdAt),
          formatReportDateTime(exportedRow.capturedAt),
          exportedRow.inspector,
          exportedRow.inspectorEmail,
          exportedRow.inspectorCode,
          exportedRow.location,
          exportedRow.manualLocation,
          exportedRow.locationLatitude,
          exportedRow.locationLongitude,
          exportedRow.profileLocation,
          exportedRow.meatType,
          exportedRow.meatTypeScopeLabel ?? "",
          exportedRow.classification,
          ...(isDeveloper ? [exportedRow.manualClassification] : []),
          exportedRow.confidenceScore,
          exportedRow.decisionSource,
          exportedRow.protocolSpoiledReason,
          exportedRow.stallNumber,
          exportedRow.certificateProof,
          exportedRow.meatExpiryDate,
          exportedRow.storageCorrect,
          exportedRow.lightColorCorrect,
          exportedRow.lightColorObserved,
          exportedRow.areaClean,
          exportedRow.regulatoryCompliance,
          exportedRow.flaggedDeviations,
          exportedRow.explanation,
          exportedRow.inspectorNotes,
          exportedRow.imageUrl,
        ];
      });
