...
**Copyright (c) 2026 Codeborne Research Group. All Rights Reserved.**
...
This prohibition applies regardless of the purpose of storage, including but not limited to accreditation records, thesis/dissertation archiving, plagiarism-detection databases, institutional backup, or research compliance retention — none of which constitute an exception under this license for any institution other than Gordon College, and even Gordon College's exception is limited strictly to Section 4.

## 4. Limited Exception — Gordon College

4.1. **Scope.** Gordon College, acting through its College of Computer Studies for the specific purpose of evaluating the Codeborne Research Group's thesis, may:
...
4.2. **What this does not permit.** This exception does **not** authorize Gordon College to:
   ...
   - deposit the Software in a public-facing institutional repository, public thesis archive, or any system accessible to students or the public generally;
   - distribute, sublicense, or grant access to any other academic institution, contractor, or third party;
   - use the Software, or any modification made under Section 4.1A, for any purpose beyond thesis evaluation and program maintenance (e.g., unrelated internal tooling, further research reuse, teaching material, or promotional use), without separate written permission from the copyright holder.

4.3. **Retention limited to institutional record-keeping.** Any copy retained by Gordon College under Section 4.1 must be kept in a restricted, access-controlled institutional archive consistent with its standard thesis record-keeping practice, and not in a general-purpose, publicly indexed, or externally shared repository (including public GitHub organizations, public LMS folders, or open institutional research repositories).

4.4. **No IP claim.** Nothing in this section transfers, assigns, or waives any copyright or other intellectual property right in the Software. Any Gordon College policy purporting to claim institutional ownership over the Software by virtue of its submission as thesis work is expressly rejected as a condition of this exception, to the maximum extent permitted by applicable law.

4.5. **Revocable.** This exception is granted to Gordon College specifically and is revocable by the copyright holder upon written notice if Gordon College exceeds the scope in Sections 4.1–4.2. Upon revocation, Gordon College becomes subject to Section 3 on the same terms as any other Academic Institution.

4.6. **No extension to other institutions.** This exception applies to Gordon College alone. It does not create precedent, custom, or an implied right for any other Academic Institution, and must not be cited as authorizing similar storage by any other institution.

## 5. Named Individual Adviser — Research Adviser

5.1. **Scope.** The individual currently serving as the Codeborne Research Group's Research Adviser, **Prof. Paul Vincent Corsina**, is individually and by name granted access to the Software, in his personal capacity as thesis adviser, for the purpose of:
   - reviewing and evaluating the thesis and its technical implementation; and
   - providing academic and methodological guidance on the Software as needed to support the thesis.

5.2. **Personal, not institutional.** This access is personal to the named individual and does not extend to any institution, employer, or organization he is otherwise affiliated with, and does not make that institution or employer an Authorized Party.
...
5.7. **No extension to successors.** This section names only the current individual in this specific role. A successor adviser, if any, is not automatically covered and must be separately named by written amendment.

## 6. Anti-Circumvention — No Institutional Instruction Overrides This License

6.1. **No compelled compliance.** No policy, directive, memorandum, thesis-submission requirement, intellectual-property assignment clause, administrative instruction, or other internal rule issued by any Academic Institution — including Gordon College, beyond the narrow scope of Section 4 — or any other non-Authorized Party can compel, authorize, or excuse a violation of Section 2 or Section 3. This is true regardless of whether the institution frames the instruction as mandatory, tied to a grade, tied to graduation clearance, or tied to accreditation compliance.

6.2. **No "institution-only" derivative repositories.** No Authorized Party, and no person with any access to the Software under this license, may create, populate, or contribute to a separate repository, archive, mirror, fork, branch, export, or storage medium that is restricted to, controlled by, or accessible only within an Academic Institution — including Gordon College beyond what Section 4 permits — regardless of whether that repository is renamed, relicensed, refactored, partially rewritten, stripped of attribution, or otherwise disguised. Any such repository is a **Successor Repository** under Section 6.4 and is prohibited on the same terms as the original.

6.3. **Personal, non-delegable obligation.** The prohibitions in Sections 3 and 4 bind the three named developers and the named adviser personally and directly, independent of any instruction from Gordon College or any other institution. Compliance with an institutional order to submit, upload, deposit, or store the Software (or any derivative, partial copy, or substantially similar reimplementation of it) beyond the scope Sections 4 and 5 permit is **not a defense** to breach of this license. "I was following institutional instructions" does not excuse the violation and does not shift responsibility away from the person who performed the act.

6.4. **Successor and reimplementation works.** Any repository, archive, or codebase that reproduces, closely paraphrases, or is substantially derived from the Software's architecture, source code, trained models, datasets, or documentation — created by an Authorized Party or anyone with access under this license, within a reasonable period of having had such access — is presumed to be a Successor Repository subject to this license, regardless of what name, license, or claimed independent authorship is attached to it. This presumption may only be rebutted with clear evidence of independent, unrelated development.

6.5. **Only binding legal process is exempted.** The sole exception to Sections 3–6, beyond Sections 4 and 5, is a valid, binding order from a Philippine court or other body with actual legal authority to compel disclosure. An internal institutional policy, thesis handbook clause, or administrative directive — from Gordon College or otherwise — is **not** such an order, no matter how it is characterized by the institution. Where a valid legal order does apply, the recipient must notify the copyright holder before complying, where legally permitted to do so.

6.6. **Forfeiture on violation.** A developer or adviser who stores, submits, or causes the Software to be stored in violation of Sections 3–6 — even under institutional pressure, grade contingency, or graduation requirement — immediately and automatically forfeits their access rights under Sections 2, 5, 8, and 9, without need for further notice, in addition to any other remedy available under Section 11.

## 7. No Implied Institutional License
...
The Software is designated as an internal tool for the exclusive operational use of the **Department of Information and Communications Technology (DICT)**, the **Department of Trade and Industry (DTI) Zambales / Region III**, and the **Olongapo City Veterinary Office** ("Authorized Agencies"), in connection with the Ikot-Palengke Program.

9.1. **Scope of grant.** The copyright holder grants the Authorized Agencies a limited, non-exclusive, non-transferable, revocable license to (a) run and use the deployed instance of the Software for official government functions related to pork meat freshness inspection under the Ikot-Palengke Program, and (b) access, modify, and create derivative works of the source code, but solely for the purpose of maintaining the Software, fixing defects, and adding features needed for the Ikot-Palengke Program. This grant does not extend to any use, distribution, or disclosure of the source code outside that maintenance purpose.

9.2. **No sublicensing or redistribution.** The Authorized Agencies may not sublicense, distribute, sell, lease, or transfer the Software, source access, or credentials to any third party, including other government agencies, contractors, consultants, or local government units not named in Section 2, without prior written consent from the copyright holder. This includes any modifications or new features developed by Authorized Agency personnel under Section 9.1(b), which remain subject to this license and may not be distributed outside the Authorized Parties.
...
9.6. **Data generated by use.** Inspection records, images, and classification outputs generated by the Authorized Agencies through use of the Software belong to the respective agency. This does not extend to the Software's underlying code, trained models, or architecture, which remain governed by this license.

9.7. **Termination.** This grant may be revoked by the copyright holder upon written notice if an Authorized Agency breaches any term of this section, including unauthorized copying, disclosure, sublicensing, or attempted codebase access outside Section 2. Upon revocation, the Authorized Agency must cease use and delete all local copies of the deployed application.
...
If any provision of this license is held unenforceable, the remaining provisions remain in full force. Specifically, if Section 6's anti-circumvention terms are found unenforceable in whole against a given institution, Sections 2 and 3 remain independently enforceable as a direct prohibition on that institution's access, and Sections 4 and 5 remain independently enforceable as the sole and exhaustive statements of Gordon College's and the named adviser's respective rights.
...
*For licensing inquiries, contact: meatlens05@gmail.com*